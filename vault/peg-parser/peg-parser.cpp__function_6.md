...

{
  ...
  "details": "This function iterates over the nodes in a PEG parse result and recursively calls the visit function on each node, passing the visitor object. This allows the visitor to inspect and modify the AST.",
